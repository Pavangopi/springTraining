...
public static void main(String[] args) {
	...
	Resource res=new ClassPathResource("com/spring/cfgs/applicationContext.xml");
	...
	FileSystemResource res3 = new FileSystemResource("src/main/java/com/spring/cfgs/applicationContext.xml");
	...
	ApplicationContext ctx  =  new FileSystemXmlApplicationContext("src/main/java/com/spring/cfgs/applicationContext.xml");
